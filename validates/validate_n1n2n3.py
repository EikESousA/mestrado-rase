...
from utils.validates.operator_presence_report import compute_operator_report_n2, compute_operator_report_n3
...
def validate_n1n2n3(
    ...
    _compute_scores([n1_model_data, n2_model_data, n3_model_data], debug_enabled)
    ...
    n3_metrics["operator_presence_report"] = {
        model: compute_operator_report_n3(data["pairs"])
        for model, data in n3_model_data.items()
    }
