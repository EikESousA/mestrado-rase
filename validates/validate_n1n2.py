...
def validate_n1n2(
    ...
    n1_model_data = prepare_model_data(
        dataset, predicts_dir, build_pairs, "generate_n1n2", label="N1"
    )
    n2_model_data = prepare_model_data(
        dataset, predicts_dir, build_pairs_n2, "generate_n1n2", label="N2"
    )
    compute_all_scores([n1_model_data, n2_model_data])
    ...
    combined: Dict[str, Any] = {
        "n1": n1_metrics,
        "n2": n2_metrics,
        "n1n2": {"models": combined_models, "averages": combined_averages},
    }
