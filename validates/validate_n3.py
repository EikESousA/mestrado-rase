...
def validate_n3(dataset_path: str, predicts_dir: str, output_path: str) -> None:
    ...
    print("Validacao N3 iniciada.", flush=True)
    ...
    for model in models:
        input_path = Path(predicts_dir) / f"generate_n3_{model}.json"
        ...
        pairs: List[Dict[str, Any]] = build_pairs_n3(dataset, predictions)
        if debug_enabled:
    ...
    if debug_enabled:
        print("Validacao N3 finalizada.", flush=True)
