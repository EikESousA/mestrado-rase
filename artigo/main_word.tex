...
FuzzyWuzzy & \pior{0.475} & 0.461 & 0.464 & \textbf{0.847} & 0.617 \\
TF-IDF & 0.636 & 0.312 & 0.417 & 0.597 & \pior{0.514} \\
\hline
\textit{Semantic similarity} & & & & & \\
SBERT & \textbf{0.801} & 0.490 & 0.594 & \melhor{\textbf{0.906}} & \textbf{0.777} \\
BERTimbau & \textbf{0.816} & 0.542 & 0.631 & \textbf{0.836} & \textbf{0.752} \\
Multilingual & \textbf{0.850} & 0.595 & 0.679 & \textbf{0.873} & \textbf{0.793} \\
\hline
\textit{Semantic distance (WMD)} & & & & & \\
WMD\_ft & \textbf{0.716} & 0.580 & 0.625 & \textbf{0.846} & \textbf{0.757} \\
WMD\_nilc & 0.688 & 0.546 & 0.595 & \textbf{0.842} & \textbf{0.742} \\
\hline
\textit{Generation-oriented metrics} & & & & & \\
BERTScore & \melhor{\textbf{0.866}} & \melhor{\textbf{0.753}} & \melhor{\textbf{0.790}} & \textbf{0.880} & \melhor{\textbf{0.843}} \\
ROUGE-L & 0.599 & 0.308 & \pior{0.404} & \textbf{0.765} & 0.616 \\
\hline
\textit{Classification metrics} & & & & & \\
Accuracy & \pior{0.475} & 0.273 & --- & 0.576 & --- \\
Precision & 0.545 & 0.202 & --- & \pior{0.024} & --- \\
Recall & \textbf{0.774} & 0.198 & --- & 0.380 & --- \\
F1-score & 0.631 & \pior{0.197} & --- & 0.043 & --- \\
\hline
\end{tabular}
\end{table}
...
\hline
 & Lexical & & Semantic & & & WMD & & Generation & \\
...
Dolphin & \melhor{0.676} & & \melhor{\textbf{0.812}} & & \textbf{0.801} & & \melhor{\textbf{0.806}} & & \\
Gemma   & 0.466 & & 0.486 & & \melhor{\textbf{0.917}} & & 0.636 & & \\
Llama   & 0.446 & & 0.479 & & \textbf{0.865} & & 0.616 & & \\
Mistral & 0.610 & & 0.670 & & \textbf{0.872} & & \textbf{0.758} & & \\
Qwen    & \pior{0.235} & & \pior{0.311} & & \pior{0.487} & & \pior{0.380} & & \\
\hline
\end{tabular}
\end{table}
...
\hline
\textit{Classification metrics} (macro per operator) & & & & & & & & & \\
Model   & Accuracy & & Precision & & Recall & & F1 & & \\
\hline
Alpaca  & \pior{0.081} & & 0.103 & & 0.109 & & 0.105 & & \\
Dolphin & 0.339 & & \melhor{0.301} & & 0.276 & & \melhor{0.286} & & \\
Gemma   & 0.182 & & 0.252 & & \melhor{0.300} & & 0.265 & & \\
Llama   & \melhor{0.439} & & 0.237 & & 0.250 & & 0.243 & & \\
Mistral & 0.434 & & 0.268 & & 0.214 & & 0.238 & & \\
Qwen    & 0.160 & & \pior{0.051} & & \pior{0.039} & & \pior{0.044} & & \\
\hline
\end{tabular}
\end{table}
...
\hline
\textit{Classification metrics} (macro per field) & & & & & & & & & \\
Model   & Accuracy & & Precision & & Recall & & F1 & & \\
\hline
Alpaca  & \pior{0.283} & & 0.012 & & 0.434 & & 0.024 & & \\
Dolphin & \textbf{0.705} & & 0.034 & & 0.447 & & 0.062 & & \\
Gemma   & 0.292 & & 0.017 & & \melhor{0.603} & & 0.033 & & \\
Llama   & \textbf{0.725} & & \melhor{0.038} & & 0.361 & & \melhor{0.067} & & \\
Mistral & \melhor{\textbf{0.760}} & & 0.037 & & 0.371 & & 0.066 & & \\
Qwen    & 0.692 & & \pior{0.004} & & \pior{0.063} & & \pior{0.008} & & \\
\hline
\end{tabular}
\end{table}
