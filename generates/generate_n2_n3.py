...
def generate_n2_n3() -> None:
    parser = argparse.ArgumentParser(description="Gerar N3 a partir do N2.")
    parser.add_argument(
        "--model",
    ...
    input_path: str = f"predicts/generate_n2_{args.model}.json"
    output_path: str = f"predicts/generate_n2_n3_{args.model}.json"
