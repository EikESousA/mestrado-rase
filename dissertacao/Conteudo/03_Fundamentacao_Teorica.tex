...
Não é necessário, entretanto, utilizar apenas RNNs para codificadores e decodificadores. É possível combinar diversos modelos, como demonstra \citeonline{mun2016}, que utiliza um codificador CNN (\textit{Convolutional Neural Networks}) \cite{lecun1998}, um codificador RNN e um decodificador LSTM em um modelo que gera legendas de imagens.
